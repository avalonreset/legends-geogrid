...
Read ../AGENTS.md, START_A_STUDY.md and QUERY_SELECTION_POLICY.md. This is an agent-assisted workflow:
...
5. Recommend 3-5 distinct evidence-backed search themes, one representative query
   ...
   Read QUERY_SELECTION_POLICY.md for the inventory and selection process. Save the selection, rejection reasons,
   ...
   failure has a restricted profile_supported route in STUDY_CONTRACT.md;
...
Read SAMPLING_POLICY.md. Do not choose 5x5 because it is cheap. Select extent
...
follow ENHANCE.md. Resolve the active completed run from the conversation and
...
See STUDY_CONTRACT.md for commands and the plan format. Low-level runners
...
automatically. Read STUDY_LIBRARY.md. Configure a vault once; never interview
